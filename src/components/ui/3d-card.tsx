...
// Provider component for MouseEnterContext
...
export const CardItem = ({
  ...
  // useEffect depends on handleAnimations
  

  // Define handleAnimations function
...
// Custom hook to use MouseEnterContext
